...
export default function ForgotPasswordForm({ open, onOpenChange }) {
    ...
    return (
        ...
        >
            <DialogContent>
                ...
                >
                    <DialogTitle className="text-2xl mb-[5px]">Forgot password</DialogTitle>
                    <DialogDescription>Retrieve your password here!</DialogDescription>
                </DialogHeader>
